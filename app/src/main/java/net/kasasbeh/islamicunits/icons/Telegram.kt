    ...
    get() {
        ...
        _Telegram = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(16f, 8f)
                arcTo(8f, 8f, 0f, isMoreThanHalf = true, isPositiveArc = true, 0f, 8f)
                ...
                arcToRelative(8f, 8f, 0f, isMoreThanHalf = false, isPositiveArc = true, -0.188f, 0.186f)
                ...
                arcToRelative(1.4f, 1.4f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.013f, -0.315f)
                arcToRelative(0.34f, 0.34f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.114f, -0.217f)
                arcToRelative(0.53f, 0.53f, 0f, isMoreThanHalf = false, isPositiveArc = false, -0.31f, -0.093f)
